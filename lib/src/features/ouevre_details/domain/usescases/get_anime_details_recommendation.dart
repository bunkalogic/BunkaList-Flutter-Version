...
class GetAnimeRecommendation extends UseCase<List<AnimeEntityRS>, Params>{

  final AnimeDetailsRecommendationAndSimilarContracts contracts;

  GetAnimeRecommendation(this.contracts);



  @override
  Future<Either<Failures, List<AnimeEntityRS>>> call(params) async{
    return await contracts.getRecommendationsAnime(params.id);
  }
