...
class GetMoviesRecommedations extends UseCase<List<MovieEntityRS>, Params>{

  final MoviesDetailsRecommendationAndSimilarContracts contracts;

  GetMoviesRecommedations(this.contracts);



  @override
  Future<Either<Failures, List<MovieEntityRS>>> call(params) async{
    return await contracts.getRecommendationsMovie(params.id);
  }
