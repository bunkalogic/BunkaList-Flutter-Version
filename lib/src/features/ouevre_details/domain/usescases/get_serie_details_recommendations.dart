...
class GetSeriesRecommedations extends UseCase<List<SeriesEntityRS>, Params>{

  final SeriesDetailsRecommendationAndSimilarContracts contracts;

  GetSeriesRecommedations(this.contracts);



  @override
  Future<Either<Failures, List<SeriesEntityRS>>> call(params) async{
    return await contracts.getRecommendationsSeries(params.id);
  }
