...
class BuildFilterParamsExplorerWidget extends StatefulWidget {

  @override
  _BuildFilterParamsExplorerWidgetState createState() => _BuildFilterParamsExplorerWidgetState();
}

class _BuildFilterParamsExplorerWidgetState extends State<BuildFilterParamsExplorerWidget> {
  ...
  Widget _buildFabSaveChanged() {
    ...
    return FloatingActionButton.extended(
      ...
      : (){
        ...
        // _newHomeTops = homeTops;

        setState(() {});

        Navigator.pushNamed(context, '/ExplorerFilter', arguments: homeTops);
      ...
      label: Row(
        children: [
          ...
          Text(
            AppLocalizations.of(context).translate("btn_filter_personalize"),
            style: TextStyle(
              color: prefs.whatModeIs ? Colors.pinkAccent[400] : Colors.deepPurpleAccent[400],
              fontSize: 16.0,
