...
class PersonalHomeTopsDetailsPage extends StatefulWidget {

  final FilterParams data;

  PersonalHomeTopsDetailsPage({
    @required this.data
    });

  @override
  _PersonalHomeTopsDetailsPageState createState() => _PersonalHomeTopsDetailsPageState();
}

class _PersonalHomeTopsDetailsPageState extends State<PersonalHomeTopsDetailsPage> {
  @override
...
class BuildPersonalHomeTopsDetailsListPage extends StatefulWidget {
  
  final FilterParams filterParams;
  
  BuildPersonalHomeTopsDetailsListPage({
    @required this.filterParams
    });

  @override
  _BuildPersonalHomeTopsDetailsListPageState createState() => _BuildPersonalHomeTopsDetailsListPageState();
}

class _BuildPersonalHomeTopsDetailsListPageState extends State<BuildPersonalHomeTopsDetailsListPage> {
  ...
  Widget _buildTitle() {
    ...
    return Text(widget.filterParams.title ?? AppLocalizations.of(context).translate("label_filter_personalize"),);
