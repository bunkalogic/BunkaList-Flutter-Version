...
abstract class AnimesPersonalTopsRemoteDataSource{

  /// Calls the http://themoviedb.org/3/discover/tv endpoint.
  ///
  /// Throws a [ServerException] for all error codes.
  
  Future<List<AnimeModel>> getPersonalTopsAnimes(
     int page,
  {
    String sortBy,
    int    year,
...
class AnimesPersonalTopsRemoteDataSourceImpl implements AnimesPersonalTopsRemoteDataSource{

   final http.Client client;
  

  AnimesPersonalTopsRemoteDataSourceImpl({@required this.client});
  ...
  Future<List<AnimeModel>> processResponse(String url) async {
    ...
    if(response.statusCode == 200){
      ...
      print('Get PersonalTops Anime total results: ${ decodedData['total_results'] }');
